...
A classe Atendente deve ter os métodos Receber pagamentos (onde o métod o recebe um valor que deve ser incrementado no valor em caixa), Fechar o caixa, Realizar Login, Realizar logoff, alterar dados e alterar senha;
 */
public class Exe02 {
    public static void main(String[] args) {
        Atendente atendente = new Atendente("João", "123456", 5000);
        Gerente gerente = new Gerente("Afonso", "123456");
        Vendedor vendedor = new Vendedor("Maria", "654321", 14000);
